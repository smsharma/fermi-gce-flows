...
We test the robustness of our results by exploring several systematic variations on the fiducial analysis, using alternative descriptions of the diffuse foreground emission template, the disk template, as well as a different region of interest. \\
