...
\end{equation}
where $r_{\mathrm s}=20\,\mathrm{kpc}$ is the Milky Way scale radius, \SM{Specify distance to GC.} and \emph{(ii)}~the Galactic disk, modeled as a doubly-exponential profile motivated by studies of Galactic millisecond pulsar populations~~\cite{Lorimer:2006qs, Bartels:2018xom},
\begin{equation}
