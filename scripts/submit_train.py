                                                    ...
                                                    for r_outer in r_outer_list:
                                                        for normalize_pixel in normalize_pixel_list:
                                                            for flow_activation in flow_activations:
                                                                batchn = batch + "\n"
                                                                batchn += "python -u train.py --sample train_ModelA_gamma_fix_thin_disk_wider_priors_1M --name gce_ModelA_gamma_fix_thin_disk_wider_priors_1M --maf_num_transforms {} --maf_hidden_features {} --fc_dims '{}' --batch_size {} --activation {} --kernel_size {} --laplacian_type {} --conv_type {} --conv_channel_config {} --aux_summary {} --n_aux {} --n_neighbours {} --conv_source {} --density_estimator {} --r_outer {} --normalize_pixel {} --flow_activation {} --num_workers 16 --max_num_epochs 30".format(maf_num_transforms, maf_hidden_features, fc_dims, batch_size, activation, kernel_size, laplacian_type, conv_type, conv_channel_config, aux_summary, n_aux, n_neighbours, conv_source, density_estimator, r_outer, normalize_pixel, flow_activation)
