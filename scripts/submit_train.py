                ...
                for method in methods:
                    for activation in activations:
                        for kernel_size in kernel_size_list:
                            batchn = batch + "\n"
                            batchn += "python -u train.py --sample train_ModelO_gamma_fix_100k --name gce_ModelO_gamma_fix_1000k --method {} --maf_num_transforms {} --maf_hidden_features {} --fc_dims '{}' --batch_size {} --activation {} --kernel_size {}".format(method, maf_num_transforms, maf_hidden_features, fc_dims, batch_size, activation, kernel_size)
